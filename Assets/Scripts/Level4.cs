...
public class Level4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if(SceneManagement.operaterrr == "Add4")
        {
            MakeMathQuestion();
        }
        if(SceneManagement.operaterrr == "Subtract4")
        {
            MakeMathQuestionSub();
        }
        if (SceneManagement.operaterrr == "Multiply4")
        {
            MakeMathQuestionMul();
        }
        if (SceneManagement.operaterrr == "Division4")
        {
            MakeMathQuestionDiv();
        }
    }
    ...
    {
        displayRandonQ1 = Random.Range(100, 9999);
        displayRandonQ2 = Random.Range(100, 9999);
    ...
    {
        displayRandonQ1 = Random.Range(10, 100);
        displayRandonQ2 = Random.Range(0, 50);
    ...
    {
        displayRandonQ1 = Random.Range(400, 1000);
        displayRandonQ2 = Random.Range(10, 100);
    ...
    {
        displayRandonQ1 = Random.Range(0, 9999);
        displayRandonQ2 = Random.Range(0, 999);
