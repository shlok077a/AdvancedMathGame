...
public class Level2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if(SceneManagement.operaterrr == "Add2")
        {
            MakeMathQuestion();
        }
        if(SceneManagement.operaterrr == "Subtract2")
        {
            MakeMathQuestionSub();
        }
        if (SceneManagement.operaterrr == "Multiply2")
        {
            MakeMathQuestionMul();
        }
        if (SceneManagement.operaterrr == "Division2")
        {
            MakeMathQuestionDiv();
        }
    }
    ...
    {
        displayRandonQ1 = Random.Range(10, 99);
        displayRandonQ2 = Random.Range(10, 99);
    ...
    void MakeMathQuestionMul()
    {
        ...
        displayRandonQ2 = Random.Range(10, 20);
    ...
    {
        displayRandonQ1 = Random.Range(0, 25);
        displayRandonQ2 = Random.Range(0, 25);
    ...
    void MakeMathQuestionDiv()
    {
        ...
        displayRandonQ2 = Random.Range(2, 20);
